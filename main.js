...
function upgradeDashboardRuntime(markdown, bundledDashboard) {
  ...
  const hasCurrentRuntime = current.includes('const DASHBOARD_RUNTIME_VERSION = "2.10.0";');
