...
const brokenDashboard = oldDashboard
  .replace('const DASHBOARD_RUNTIME_VERSION = "2.3.0";', 'const DASHBOARD_RUNTIME_VERSION = "2.0.0";')
...
if (!runtimeUpgraded.includes('const DASHBOARD_RUNTIME_VERSION = "2.3.0";')) throw new Error("Dashboard runtime was not upgraded");
