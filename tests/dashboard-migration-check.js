...
const brokenDashboard = oldDashboard
  .replace('const DASHBOARD_RUNTIME_VERSION = "2.6.1";', 'const DASHBOARD_RUNTIME_VERSION = "2.0.0";')
...
if (!runtimeUpgraded.includes('const DASHBOARD_RUNTIME_VERSION = "2.6.1";')) throw new Error("Dashboard runtime was not upgraded");
